...
* Install the requirements (in sync with Dockerfile)::
    ...
    sudo apt install autogen automake bc bison build-essential check cmake curl cython debootstrap expect flex g++-multilib gettext git gperf imagemagick intltool libbz2-dev libc6-i386 libcppunit-dev libffi-dev libgc-dev libgmp3-dev libltdl-dev libmount-dev libncurses-dev libpcre3-dev libssl-dev libtool libunistring-dev lzip mercurial ncurses-dev php pkg-config scons subversion swig unzip xmlto zlib1g-dev
    sudo apt install python3 python3-distutils python3-pip python python-pip
    sudo pip install -U setuptools pip wheel httpie
    sudo pip3 install -U setuptools pip wheel httpie
